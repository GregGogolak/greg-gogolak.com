...
Return:
{"trades":[{"buy_date":"YYYY-MM-DD","sell_date":"YYYY-MM-DD","buy_price":number,"sell_price":number,"shares":number,"ticker":"NVDA"}],"skipped":["Row N: reason (only for genuinely unparseable dates)"]}
