...
export function calculateTrade({
  ...
  // Platform fee — $96 per unique calendar day, but only if not already charged
  ...
  const buyDayFee  = buyDayAlreadyCharged ? 0 : 96
  const sellDayFee = (buy_date === sell_date || sellDayAlreadyCharged) ? 0 : 96
